!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : t(
        ((e =
          'undefined' != typeof globalThis ? globalThis : e || self).klipSDK =
          {}),
      )
})(this, function (e) {
  'use strict'
  !(function (e) {
    ...
    function s(e, t) {
      ...
      Array.isArray(t)
        ? (s = i.concat(t))
        : 'string' == typeof t && (s = i.concat([t]))
      for (var a = 0, c = s.length; a < c; a += 1) {
        var u = s[a]
        if ((r = new RegExp('(' + u + ')[ \\/]([\\w._\\-]+)').exec(e))) break
      }
      return (
        r || (r = ['', '']),
        r[1]
          ? ((n.isApp = !0), (n.name = r[1]), (n.version = o(r[2])))
          : (n.isApp = !1),
        n
      )
    }
    var a = (e.userAgent = function (e, o) {
      var i = (function (e) {
        return e
          ? e.toLowerCase()
      ...
      return { ua: i, browser: t(i), platform: n(i), os: r(i), app: s(i, o) }
    })
    'object' == typeof window &&
      window.navigator.userAgent &&
      (window.ua_result = a(window.navigator.userAgent) || null)
  })(
    'object' == typeof e
      ? ((e.daumtools = e), (e.util = e), e)
      : 'object' == typeof window
      ? ((window.daumtools =
    ...
    (function (e) {
      e.web2app = (function () {
        ...
        function s() {
          for (
            var e = ['hidden', 'webkitHidden'], t = 0, o = e.length;
            t < o;
            t++
          )
        ...
        return function (e) {
          var c,
            ...
            p =
              'function' == typeof e.willInvokeApp
                ? e.willInvokeApp
                : function () {},
            l = 'function' == typeof e.onAppMissing ? e.onAppMissing : r,
            f =
          ...
          p(),
            o.android
              ? ((u = t.browser.chrome && +t.browser.version.major >= 25),
                (d = new RegExp(n.join('|'), 'i')),
                u && !d.test(t.ua) && e.intentURI && !e.useUrlScheme
                  ? (function (e) {
                      t.browser.chrome ? o() : setTimeout(o, 100)
                      function o() {
                        top.window.location.href = e
                      }
                    })(e.intentURI)
                  : e.storeURL &&
                    ((c = e.urlScheme), i(300, e.storeURL, l), a(c)))
              : o.ios && e.storeURL
              ? (function (e, o, n, r) {
                  var c = i(2e3, o, n)
                  parseInt(t.os.version.major, 10) < 8
                    ? (function (e) {
                  ...
                  parseInt(t.os.version.major, 10) > 8 && t.os.ios
                    ? (void 0 === r ? (r = e) : clearTimeout(c),
                      (function (e) {
                        top.window.location.href = e
                      })(r))
                    : a(e)
                })(e.urlScheme, e.storeURL, l, e.universalLink)
              : setTimeout(function () {
                  f()
                }, 100)
        }
    ...
    (function (e) {
      ;(e.daumtools = void 0 === e.daumtools ? {} : e.daumtools),
        void 0 !== e.daumtools.web2app &&
          (e.daumtools.web2app.version = '1.1.1')
    })(window)
  var t =
      ('undefined' != typeof globalThis && globalThis) ||
      ('undefined' != typeof self && self) ||
      (void 0 !== t && t),
    o = 'URLSearchParams' in t,
        ...
        ;(this.bodyUsed = this.bodyUsed),
          ...
          e
            ? 'string' == typeof e
              ...
              : s && r && (t = e) && DataView.prototype.isPrototypeOf(t)
  ...
  function T(e, o) {
    return new Promise(function (n, i) {
      ...
      ;(c.onload = function () {
        ...
        o.url =
          'responseURL' in c ? c.responseURL : o.headers.get('X-Request-URL')
        ...
        !o || 'object' != typeof o.headers || o.headers instanceof l
          ? a.headers.forEach(function (e, t) {
              c.setRequestHeader(t, e)
            })
          : Object.getOwnPropertyNames(o.headers).forEach(function (e) {
              c.setRequestHeader(e, d(o.headers[e]))
            }),
        a.signal &&
  ...
  ;(T.polyfill = !0),
    t.fetch ||
      ((t.fetch = T), (t.Headers = l), (t.Request = _), (t.Response = v))
  const { web2app: k, userAgent: P } = e,
    {
      SERVER_URL: O,
      A2A_URL_SCHEME: L,
      KAKAO_INTENT_SHCEME: S,
      KLIP_APP_INTENT_SHCEME: x,
      IOS_KAKAO_APP_STORE_LINK: j,
      AOS_KAKAO_APP_STORE_LINK: I,
      IOS_KLIP_APP_STORE_LINK: R,
      AOS_KLIP_APP_STORE_LINK: U,
      KAKAOTALK_PACKAGE_NAME: K,
      KLIP_APP_PACKAGE_NAME: N,
      KAKAO_APP_NAME: B,
      KLIP_APP_NAME: C,
    } = {
      SERVER_URL: 'https://a2a-api.klipwallet.com/v2/a2a',
      A2A_URL_SCHEME: 'klipwallet/open?url=https://klipwallet.com/?target=a2a',
      KAKAO_INTENT_SHCEME: 'kakaotalk',
      KLIP_APP_INTENT_SHCEME: 'klip',
      ...
      KAKAO_APP_NAME: '移댁뭅�ㅽ넚',
      KLIP_APP_NAME: '�대┰',
    },
    $ = {
      auth: ({ bappName: e, successLink: t, failLink: o }) =>
        fetch(O + '/prepare', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            bapp: { name: e, callback: { success: t, fail: o } },
            type: 'auth',
          }),
        }).then((e) => e.json()),
      sendKLAY: ({
        ...
        fetch(O + '/prepare', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            bapp: { name: e, callback: { success: r, fail: i } },
            type: 'send_klay',
            transaction: { from: t, to: o, amount: n },
          }),
        }).then((e) => e.json()),
      sendToken: ({
        bappName: e,
        ...
        fetch(O + '/prepare', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            bapp: { name: e, callback: { success: i, fail: s } },
            type: 'send_token',
            transaction: { from: t, to: o, amount: n, contract: r },
          }),
        }).then((e) => e.json()),
      sendCard: ({
        bappName: e,
        ...
        fetch(O + '/prepare', {
          ...
          body: JSON.stringify({
            bapp: { name: e, callback: { success: i, fail: s } },
            type: 'send_card',
            transaction: { from: t, to: o, card_id: n, contract: r },
          }),
        }).then((e) => e.json()),
      executeContract: ({
        bappName: e,
        ...
        fetch(O + '/prepare', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            bapp: { name: e, callback: { success: s, fail: a } },
            type: 'execute_contract',
            transaction: { from: t, to: o, value: n, abi: r, params: i },
          }),
        }).then((e) => e.json()),
      signMessage: ({
        bappName: e,
        ...
        fetch(O + '/prepare', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            bapp: { name: e, callback: { success: n, fail: r } },
            type: 'sign_message',
            message: { value: t, from: o },
          }),
        }).then((e) => e.json()),
    },
    D = (e) => {
      e ? e() : alert('紐⑤컮�� 湲곌린�먯꽌留� �댁슜 媛��ν븳 湲곕뒫�낅땲��.')
    }
  ;(e.getCardList = ({ contract: e, eoa: t, cursor: o }) =>
    fetch(`${O}/cards?sca=${e}&eoa=${t}&cursor=${o}`, { method: 'GET' }).then(
      (e) => e.json(),
    )),
    (e.getResult = (e) =>
      fetch(`${O}/result?request_key=${e}`, { method: 'GET' }).then((e) =>
        e.json(),
      )),
    (e.prepare = $),
    (e.request = (e, t, o = !1) => {
      const n = P()
      let r = `${n.os.android ? 'kakaotalk' : S}://${L}/?request_key=${e}`,
        i = n.os.android ? I : j,
        s = B,
        a = `intent://${L}/?request_key=${e}#Intent;scheme=${
          n.os.android ? 'kakaotalk' : S
        };package=${K};end;`
      o &&
        ((r = `${x}://${L}/?request_key=${e}`),
        (i = n.os.android ? U : R),
        (s = C),
        (a = `intent://${L}/?request_key=${e}#Intent;scheme=${x};package=${N};end;`))
      const c = !(n.browser.chrome && +n.browser.version.major >= 25)
      k({
        urlScheme: r,
        useUrlScheme: c,
        intentURI: a,
        ...
        onAppMissing: o
          ? () =>
              k({
                ...
                useUrlScheme: c,
                intentURI: `intent://${L}/?request_key=${e}#Intent;scheme=${
                  n.os.android ? 'kakaotalk' : S
                };package=${K};end;`,
                storeURL: i,
                appName: '移댁뭅�ㅽ넚',
